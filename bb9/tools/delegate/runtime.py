...
from bb9.core.agents import load_worker
...
def _task_from_action(action: Action) -> Task:
    ...
    return Task(
        ...
        max_iterations=_positive_int(params.get("max_iterations"), default=4),
    )
...
def _load_worker(context: RunContext, worker: str):
    ...
    return load_worker(agents_dir, parent, worker, fallback_worker="dev")
